...
Outra opção é utilizar **disjuntores**, como, por exemplo, {% raw %}{{{% endraw %}intervalo1 || intervalo2}}, caso em que, não havendo valores para o “intervalo1” será retornado o valor do “intervalo2”. 
